...
export function LessonView({
  ...
  return (
    <div className="lesson-view-wrapper">
      ...
      <article className="lesson-view" data-domain={domainForChapter(lesson.chapterId)}>
        <header className="lesson-header">
          <span className={`scope-badge ${SCOPE_CLASS[lesson.scope]}`}>{lesson.scope}</span>
